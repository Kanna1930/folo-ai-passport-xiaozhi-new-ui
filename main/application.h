...
public:
    ...
    // Reset the screen inactivity timer and restore the saved LCD brightness.
    // Used by buttons, wake word, notifications and state changes.
...
private:
    ...
    int clock_ticks_ = 0;
    uint16_t screen_idle_seconds_ = 0;
    bool screen_is_off_ = false;
    static constexpr uint16_t kScreenOffTimeoutSeconds = 180;
